# Sample code to get you started -- Dylan Brewer, 2026
...
# Import packages - you may need to type "pip install numpy pandas matplotlib scipy statsmodels seaborn jinja2" the first time you use this set of packages, for example.
...
outputpath = r'C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2026-db\homework1\sample_code\output'
...
output.to_latex("sampleoutput.tex", float_format="%.2f", index=True)
