...
* Set up your working directories
	...
	* local datapath = "C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2026-db\homework1" // Typically, where you keep the data and where you want the outputs to go will be different.  In this sample code, this is not the case so I don't specify a data path.
	local outputpath = "C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2026-db\homework1\sample_code\output"
	if "`c(username)'" == "dbrewer30" { // This lets me change the working directory based on which computer I am on.
		local outputpath = "/Users/dbrewer30/Dropbox (Personal)/teaching/Courses/BrewerPhDEnv/Homeworks/phdee-2026-db/homework1/sample_code/output"
	}
