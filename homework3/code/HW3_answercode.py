...
datapath = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2026-db\homework2'
outputpath2 = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2026-db\homework3\output'
...
lb4 = np.percentile(olsbeta4blist,2.5,axis = 0,method = 'lower')
ub4 = np.percentile(olsbeta4blist,97.5,axis = 0,method = 'higher')

lbmfx4 = np.percentile(mfx4blist,2.5,axis = 0,method = 'lower')
ubmfx4 = np.percentile(mfx4blist,97.5,axis = 0,method = 'higher')
...
### Make Observations print as an integer
outputtable4.loc['Observations', 'Coefficients'] = f"{int(nobs4)}"
outputtable4.loc['Observations', 'Marginal effects (dy/dx)'] = f"{int(nobs4)}"
